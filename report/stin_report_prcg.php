...
<div class="mt-2" style="padding: 2%;">
    ...
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <a href="stin_report_prcg.php?date1=&date2="><button class="nav-link active" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">PRCG</button></a>
        </div>
    </nav>
                        ...
                        <div class="p-5 mt-3 bg-body rounded printPage" style="width:100%;border:5px solid #cce0ff" id="report">
                            ...
                            <div class="report">
                                ...
                                WHERE stin_tb.stin_date 
                                    BETWEEN '$date1' AND '$date2' AND dept_tb.dept_name LIKE '%PRCG%'
                                ";
