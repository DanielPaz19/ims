...
<div class="mt-2" style="padding: 2%;">
    ...
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <a href="sales-report.php?date1=&date2="><button class="nav-link active" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Generate by Date</button></a>
            <a href="sales-report_customer.php?date1=&date2="><button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">By Customer</button></a>
