                        ...
                        <div class="row">
                            ...
                            <div class="col p-3">
                                <div class="container text-primary payment__form--container">
                                    <form action="payment-cash.php" method="post" style="width: 100%" class="container m-4 mx-auto">
                                        ...
                                        <div class="checkbox--container container text-center my-2" style="width: 100%">
                                            <span class="form-check mx-3" style="display: inline-block">
                                                <input checked class="form-check-input" type="radio" name="payment_option" id="cash_payment" required />
                                            ...
                                            <span class="form-check mx-3" style="display: inline-block">
                                                <input class="form-check-input" type="radio" name="payment_option" id="bank_payment" />
                                        ...
                                        <div class="form_control-container container mt-5" style="width: 90%">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control payment__date" id="trans_date" required max="2022-07-01" />
                                            </div>
                                            <div class="mb-3">
