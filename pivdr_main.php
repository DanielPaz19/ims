        ...
        <fieldset style="border: none;">
            <legend>
                <h2 style="letter-spacing: 5px;">
                    <font color="midnightblue">PIVDR</font>
                </h2>
            </legend>
            <hr style=" border: 0;height: 1px;background-image: linear-gradient(to right, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0));">
            <?php include('table/pivdr_table.php') ?>
    </div>
    </fieldset>
</div>
...
<script type='text/javascript'>
    function showadditem() {
        ...
        window.open('main/addrecord/addpivdr.php',
            "Contact The Code Ninja",
            "menubar=no,resizable=yes,width=700,height=900,scrollbars=yes,left=" +
