...
<fieldset style="border: none;">
  <legend><h2 style="letter-spacing: 5px;"><font color="midnightblue">Storeroom Reciepts Register</font></h2></legend>
  <hr style=" border: 0;height: 1px;background-image: linear-gradient(to right, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0));">
<?php include ('../table/srr_table.html')?>
</div>
...
tr:nth-child(even) {background-color: #E7E8F8;}
...
<script type='text/javascript'>
   function showadditem() {
      ...
      window.open('../main/addrecord/addsrr.php', 
