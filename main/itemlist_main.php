...
<fieldset style="border: none;">
  <legend><h2 style="letter-spacing: 6px;"><font color="midnightblue"><center>ITEMLIST</font></h2></legend>
  <hr style=" border: 0;
    height: 1px;
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <fieldset style="border:none">
        <legend style="font-weight: bolder; letter-spacing: 6px;"><h2>ITEM DETAILS</h2></legend>
        ...
        <form method="GET" autocomplete="off" action="../php/connect/itemlist_additem_con.php">
            ...
            <table width="100%"  >
                    ...
                    <tr>
                        <td> <input type="text" name="product_name" style=" width:460px;border: 1px solid gray; height: 36px; border-radius: 5px;"></td>
...
<hr style=" border: 0;height: 1px;background-image: linear-gradient(to right, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0));" >
     <p style="float: left;"><i>Fill out form with </i>&nbsp;<i style="color: red;" class='fas fa-exclamation-circle'></i></p><br>
                    ...
                    <div class="buttons">
                        <button type="submit" class="button" name="add" onclick="alert('Add Item Successfully!!')">Save</button>
                    </div>
            </form>
...
<script>function setDecimal(event) {this.value = parseFloat(this.value).toFixed(13);}</script>
<script>
    $(document).ready(function() {
