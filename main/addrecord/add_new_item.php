    ...
    <div class="content">
        ...
        <form method="GET" autocomplete="off">
            ...
            <table width="100%">
                ...
                <tr>
                    <td><input required="number" type="number" name="qty" onchange="setDecimal" min="0" max="9999999999" step="0.0000001" style="width: 250px; height: 35px; border: 1px solid gray; border-radius: 5px;" value="0" readonly></td>
