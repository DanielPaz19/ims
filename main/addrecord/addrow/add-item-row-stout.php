...
if (mysqli_num_rows($result) > 0) {
  ...
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo "<tr>
        ...
        <td><input name='stout_temp_remarks[]' style='border:none;' value='" . $item_remarks . "' readonly></td>
  ...
  echo '0 results';
    ...
    // <td><textarea name='stout_temp_remarks[]' style='border:none; resize:none;'>'" . $item_remarks . "'</textarea></td>