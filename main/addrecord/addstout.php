...
<body style="background-color:#cce0ff">
  <div class="container-sm">
    <div class="card card-lg border-light-grey mb-3 mt-3 shadow" style="max-width: 100%;">
      <div class="card-header" style="background-color: #0d6efd;color:white;letter-spacing:2px">Stock-Inventory OUT: Entering records <i class="bi bi-pencil"></i>
      </div>
      <div class="card-body">
        <div id="search">
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-7">
              <div class="form-floating">
                <textarea class="form-control item-remarks " id="floatingTextarea"></textarea>
          ...
          <form autocomplete="off" method="GET" action="../addrecord/itemInsert/stoutInsert.php">
            <div class="row">
              <div class="col">&nbsp;STOUT ID : <span class="newStoutId"></span></div>
            </div>
            <div class="row">
              <div class="col">
                <div class="form-floating mb-3">
                  <input type="text" class="form-control" id="floatingInput" name="stout_code">
                  <label for="floatingInput">Stock-Out Code</label>
                </div>
              </div>
              <div class="col">
                <div class="form-floating mb-3">
                  <input type="text" class="form-control" id="floatingInput" name="stout_title">
                  <label for="floatingInput">Job-Order No.</label>
                </div>
              </div>
              <div class="col">
                <div class="form-floating mb-3">
                  <input type="date" class="form-control" id="floatingInput" name="stout_date">
            ...
            <div class="row">
              <div class="col">
                <div class="form-floating mb-3">
                  <input type="text" class="form-control" id="floatingInput" name="itemdesc">
                  <label for="floatingInput">Item Description</label>
                </div>
              </div>
              <div class="col">
                <div class="form-floating">
                  <textarea class="form-control item-remarks " id="floatingTextarea" name="stout_remarks"></textarea>
                  <label for="floatingTextarea">Stock-Out Remarks</label>
                </div>
              </div>
              <div class="col">
                <div class="form-floating">
            ...
            <div class="table-responsive">
              <table id="crud_table" width="100%" class="table postb">
                <tr>
              ...
              <button name="btnsave" class="btn btn-success stout-button-save">&nbsp;Save Record</button> <br> <br>
          </form>
        </div>
        <br>