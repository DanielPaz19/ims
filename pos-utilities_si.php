...
$query = "SELECT invoice.invoice_id,invoice.invoice_number,dr_inv.dr_number,customers.customers_name,invoice.invoice_date,user.user_name 
FROM invoice 
...
<body>
    <main style="background-color: aliceblue;">
        ...
        <section id="content2" style=" padding:2%;border: 1px solid #ddd;background-color:white;height:auto;box-shadow: 5px 5px 5px #aaaaaa;">
            ...
            <div class="row">
                <div class="col">
                    <h3 style="color: #443DFE;"> <span class="shopee">Sales Invoice Records</span> </h3>
                </div>
            ...
            <div class="table-responsive">
                ...
                <table id="data" class="table table-striped" data-order='[[ 0, "desc" ]]'>
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        if ($row["invoice_number"] == 0 or $row["customers_name"] == "") {

                            $disable = ' <a href="view/pos-utilities_print_si.php?inv_number=' . $row["invoice_number"] . '">
                            <button type="button" class="btn btn-outline-success btn-sm" disabled><i class="bi bi-printer"></i> Re-Print Sales Invoice</button></a>        
                           ';
                        } else {
                            $disable = ' <a href="view/pos-utilities_print_si.php?inv_number=' . $row["invoice_number"] . '">
                            <button type="button" class="btn btn-outline-success btn-sm"><i class="bi bi-printer"></i> Re-Print Sales Invoice</button></a>   ';
                        }
                        ...
                        echo '  
                               <tr>  
                                    <td align="left">' . str_pad($row["invoice_id"], 8, 0, STR_PAD_LEFT) . '</td>  
