...
<div class="container">
  <a href="../main/stin_main.php" style="float: right; color: red;" title="Close"><i class="fa fa-close" style="font-size:24px"></i></a>
<input type="hidden" name="id" value="<?php echo $id; ?>"/>
  <!-- Stock-In Details -->
<fieldset class="fieldset">
  <legend><h2>Stock-In Details</h2></legend>
...
?>
  <tr>
    ...
    <td contenteditable="false"><font color="red"><input type="number" name="in_qty[]" value="<?php echo $irow['stin_temp_qty']?>" style="border: none"></font></td>
