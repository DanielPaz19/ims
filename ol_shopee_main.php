...
<body>
    <main style="background-color: aliceblue;">
        ...
        <section id="content1" style=" padding:2%;border: 1px solid #ddd;background-color:white;height:auto;box-shadow: 5px 5px 5px #aaaaaa;">
            ...
            <a href="itemlist_main.php" style="float: right;text-decoration:none;color:orange;font-weight:bold"> <i class="bi bi-chevron-left"></i>&emsp;Back to Itemlist</a>
            <div class="row">
                <div class="col">
                    <h3 style="color: orange;"> <span class="shopee">Shopee Income Statement Records</span> </h3>
                </div>
                <div class="col"><button class="btn btn-sm" style="float: right;background-color:orange;color:white" onclick="showaddOl()">+ Add New Records</button></div>
            </div>
