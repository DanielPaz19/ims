...
$query = "
SELECT product.product_id, product.product_name, class_tb.class_name, product.qty, unit_tb.unit_name, product.pro_remarks, loc_tb.loc_name, product.barcode, product.price, product.cost, dept_tb.dept_name, class_tb.class_id
FROM product
...
if($total_data > 0)
{
  foreach($result as $row)
  {
    ...
    <tr>
      ...
      <a href="../edit/itemlist_edit.php?id='.$row["product_id"]."&class=".$row["class_id"]."&className=".$row["class_name"]."&unit=".$row["unit_name"]."&dept=".$row["dept_name"]."&loc=".$row["loc_name"].'" title="Edit Item"><i class="fa fa-edit" style="font-size:25px"></i></a>
      &nbsp;
