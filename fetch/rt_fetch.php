...
WHERE rt_tb.rt_no LIKE '%$qry%' OR customers.customers_name LIKE '%$qry%'  ORDER BY rt_tb.rt_id DESC
...
if ($total_data > 0) {
    foreach ($result as $row) {
        ...
        if ($closed == 0) {
            ...
            $disable = ' <a href="rt_edit-page.php?edit&id=' . $row["rt_id"] . '" disabled> <button class="btn btn-success" title="Edit"><i class="bi bi-pencil-fill"></i></button></a>
                  ...
                  <a href="#" onclick="confirmAction()"><button class="btn btn-danger" title="Delete"><i class="bi bi-trash3-fill"></i></button></a>
       ';
        } else {
