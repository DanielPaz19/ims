...
<div class="content">
	...
	<table width="100%">
		<tr>
			<td><p style="float: left;"><b>Requested By:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><?php echo $emp_name;?></p></td>
			<td><p style="float: right;"><b>Department:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><?php echo $dept_name;?></p></td>
		</tr>
	</table>
...
<br><br><br>
	...
	<a href="../main/stout_main.php"><button id="printPageButton">Back</button></a>
