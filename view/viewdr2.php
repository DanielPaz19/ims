...
<body>  
        ...
        <p style="position: absolute;left:17cm;top:3.5cm;margin:0;"> <?php echo $drNo?></p>
                ...
                ?>
                        <tr>
                            <td style="width: 1.9cm;height:0.6cm;text-align:center"><?php echo $irow['pos_temp_qty'] ?></td>
                            <td style="width: 2.25cm;height:0.6cm;text-align:center"><?php echo $irow['unit_name'] ?></td>
                            <td style="width: 10.5cm;font-size: 11.5px;"><?php echo $irow['product_name'] ?></td>
                ...
                <tr>
                 ...
                 <p style="position: absolute;top:14.4cm;left:1.5cm">JO<?php echo $joNo?></p>
