            ...
            <div class="col-4">
                <div class="card" style="padding: 10%; background-color:aliceblue;">
                    ...
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <i class="bi bi-info-circle-fill"></i> Choose on <strong>Department & Date Range</strong> listed below to generate reports based on inventory records.
            ...
            <div class="content col-8" style="background-color: white;">
                <div id="report">
                    ...
                    <div class="dept-title">
                        ...
                        $date1 = date("m/d/Y", strtotime($_GET['date1']));
                        $date2 = date("m/d/Y", strtotime($_GET['date2']));
                        ...
                        <div class="row">
                            <div class="col">
                                <strong>Scope :</strong> <?php echo $date1 ?> to <?php echo $date2 ?>
                            </div>
                            <div class="col" style="text-align:right">
                        ...
                        if (isset($_GET['search'])) {
                            ...
                            while ($rowsCompany = mysqli_fetch_assoc($selectCompany_Query)) {
                                ...
                                if (!in_array($companyName, $comArray)) {
                                    ...
                                    echo "<tr>";
                                    // echo "<td style='width:10% ;font-weight:bold'> </td>";
                                    echo "<td style='width:50%;font-weight:bold'>PRODUCT DESCRIPTION</td>";
                                    ...
                                    $selectPerson = "SELECT
                                    product.product_id, product.product_name,class_tb.class_name,product.qty,unit_tb.unit_name,loc_tb.loc_name,dept_tb.dept_id,product.pro_remarks,loc_tb.loc_name
                                    FROM product
                                    LEFT JOIN dept_tb ON dept_tb.dept_id = product.dept_id
                                    LEFT JOIN class_tb ON class_tb.class_id = product.class_id
                                    LEFT JOIN unit_tb ON unit_tb.unit_id= product.unit_id
                                    -- LEFT JOIN move_product ON move_product.product_id = product.product_id
